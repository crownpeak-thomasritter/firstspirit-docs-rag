...
function EmptyState({ onStarterClick }: EmptyStateProps) {
  const starters = [
    'How do I configure CMS_INPUT_DOM?',
    'What are the JVM heap tuning recommendations for FirstSpirit?',
    'How do I install a FirstSpirit module?',
    'What does the project export format look like?',
  ];
